...
export default function CTA() {
  const stats = [
    { value: '98%', label: 'Guest Satisfaction', icon: Users },
    { value: '24/7', label: 'Guest Support', icon: Shield },
    { value: '6', label: 'Premium Properties', icon: Zap },
    { value: '500+', label: 'Happy Guests', icon: Sparkles },
  ];
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                ...
                <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                  Premium Local Living?
                </span>
              </h2>

              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Book directly with Local Stays Rentals and save on platform fees while enjoying
                personalized service and premium accommodations in the heart of the city.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Book directly and receive immediate confirmation
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                All apartments professionally managed and maintained
              </p>
            </div>
